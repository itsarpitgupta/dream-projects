...
if __name__ == '__main__':
    # Read input image
    imgIn = cv2.imread("D:\\github-repos\\dream-projects\\deep-vision-py\\DATA\\robot.jpg")
    ...
    # Output triangle
    triOut = np.float32([[[360, 200], [60, 250], [450, 400]]])
    ...
    displayImageOutput(main_img=imgIn, main_img_title="main_image", result_img=imgOut, result_img_title="result_image",title="")
